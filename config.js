...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://technclever_db_user:KXPyJRAGvAYfX1WG@cluster700.pnbzsmb.mongodb.net',
    
    // ===========================================================
    // 2. INFORMATIONS DU BOT
    // ==========================================================
    PREFIX: process.env.PREFIX || '.',
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+255794469700', // Mettez votre numéro ici
    BOT_NAME: "Arslan MD Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✮⃝𝐀ⁿᵒⁿʸᵐᵒᵘˢ✮⃝ᵁˢᵉʳ ✮',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/FHT9hXCbu1z4XiPbn7HKMw',
    ...
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb73SRl1CYoLWtyr4u1X',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8727379400:AAEHADCRUPpL73rSlvsJE700ivrWl0FUXhk',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+7667368794'
